package com.akpwebdesign.Breakout.screen;
 ...
 * @author liamzebedee
 * 
 *         Created by Liam Edwards-Playne | http://cryptum.net Licensed under
 *         GPLv2 license
 * 
 ...
 * debugDraw.setFlags(DebugDraw.e_shapeBit); world.setDebugDraw(debugDraw); //
 * Where world is your JBox2D world
 * 
 * 
 * Available flags from JBox2D DebugDraw:
 * 
 * 
 * public static final int e_shapeBit = 0x0001; // < draw shapes public static
 * final int e_jointBit = 0x0002; // < draw joint connections public static
 * final int e_coreShapeBit = 0x0004; // < draw core (TOI) shapes public static
 * final int e_aabbBit = 0x0008; // < draw axis aligned bounding boxes public
 * static final int e_obbBit = 0x0010; // < draw oriented bounding boxes public
 * static final int e_pairBit = 0x0020; // < draw broad-phase pairs public
 * static final int e_centerOfMassBit = 0x0040; // < draw center of mass frame
 * public static final int e_controllerBit = 0x0080; // < draw controllers
 * 
 * 
 * @see
 * http://code.google.com/p/jbox2d/source/browse/branches/jbox2d-2.0.1/src/org
 * /jbox2d/dynamics/DebugDraw.java
 */
public class Slick2DJBox2DDebugDraw extends DebugDraw {
	...
	public Slick2DJBox2DDebugDraw(final GameContainer gameContainer) {
		...
		this.viewportTransform.setCenter(gameContainer.getWidth() / 2,
				gameContainer.getHeight() / 2);
	...
	public void drawTransform(final Transform xf) {
		...
		temp2.x = xf.p.x + k_axisScale * xf.q.getCos();
		temp2.y = xf.p.y + k_axisScale * xf.q.getSin();
